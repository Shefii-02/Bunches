            ...
            <div class="row">
                ...
                <!--////////////////////////////////////Product Price/////////////////////////////////////////-->  
                        <div class="product-price">
                            <h4 class="new-price"><span id="product_price">{{max_price($products->id)}}</span></h4>
                        </div>
                        <!--////////////////////////////////////Product description/////////////////////////////////////////-->                  
                                                    ...
                                                    <!--/////////// Show First Option ////////////////////-->  
                                                                <div class="col-6 col-lg-4 text-center option_vals cursor-pointer">
                                                                    ...
                                                                    <div class="round-checkbox  mb-2"> 
                                                                        <input type="radio" name="single_selection" @if($products->option->where('type',$second_option)->count() == 0 && ($variation_data))  data-vname="{{$variation_data->variation}}" data-price="{{$variation_data->price}}" data-id="{{$variation_data->variation_id}}" @endif data-option="{{$size_items->id}}" @if($key1 == 0) checked @endif class="vari_checkbox" id="checkbox_option_rounded_{{$size_items->id}}">
                                                                                                            ...
                                                                                                            <div class="card position-relative bg-white second_section border-0" data-childId="child_div_{{$type_items->id}}">
                                                                                                                <div class="row">
                                                                                                                    ...
                                                                                                                    <div class="round-radio ">
                                                                                                                        <input type="radio" data-childId="child_div_{{$type_items->id}}"  class="option__type" @if($third_option == '') data-vname="{{$variation_data->variation}}"  data-price="{{$variation_data->price}}" data-id="{{$variation_data->variation_id}}" @endif  name="vari_type_{{$key1}}" @if($key1 == 0 && $ii == 0) checked @endif  id="radio_rounded_{{$key1}}_{{$key2}}">
                                ...
                                <div class="cart-item ps-1 pe-1">
                                    ...
                                    <div class="cart-item-details ps-2">
                                        ...
                                        @if($listing->product_variation)
                                            <p>{{$listing->product_variation}}</p>
                                        @endif
                                        <span class="cart-item-price Item_total">{{getPrice($listing->price_amount * $listing->quantity)}}</span>
                                    </div>
                                    <button class="delete-btn" data-preorder="{{$listing->pre_order}}" data-pname="{{$listing->product_name}}" data-psku="{{$listing->product_sku}}" data-pid="{{$listing->product_variation_id}}"  data-price="{{$listing->price_amount}}"><i class="bi bi-trash"></i></button>
                                </div>
                                @php
