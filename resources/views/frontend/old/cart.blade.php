                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach($items as $listing)
                                    <tr class="cart-item position-relative" data-pname="{{$listing->product_name}}" data-psku="{{$listing->product_sku}}" data-pid="{{$listing->product_variation_id}}"  data-price="{{$listing->price_amount}}">
                                        ...
                                        <td >
                                            <div class="item_remove cursor-pointer" data-preorder="{{$listing->pre_order}}" data-pname="{{$listing->product_name}}" data-psku="{{$listing->product_sku}}" data-pid="{{$listing->product_variation_id}}"  data-price="{{$listing->price_amount}}">
