                            ...
                            @foreach(App\Models\Store::Orderby('display_order','asc')->get() as $store)
                                <div class="col-md-6 col-lg-3">
                                    <div class="contact_store text-center mb-5">
                                        <img src="{{asset('images/store/'.$store->picture_icon)}}" style="width:150px;height:auto;">
                                        <p style="line-height:110%;"><small>{{$store->address}} {{$store->postal_code}} <br/> <strong>{{$store->city}}</strong> {{$store->province}}</small></p>
                                        <p class="text-center d-flex flex-wrap justify-content-center">
                                            <a class="mb-1 store_button" href="tel:{{$store->phone}}"><i class="bi bi-telephone"></i> Call</a>
                                            <a class="mb-1 store_button" href="{{url('contact?store='.$store->slug)}}" class="store_ordernow"><i class="bi bi-envelope " ></i> Inquiry</a>
                                            <a  class="mb-1 store_button" target="map_new" href="{{$store->map_link}}"><i class="bi bi-geo"></i> Directions</a>
                                        </p>
                                    </div>
                                </div>
                            @endforeach
