...
class FrontendController extends Controller
{
    ...
    public function index(Request  $request)
    {
        ...
        $blogs          = Blog::orderBy('published_at','DESC')->whereType('blog')->limit('8')->get();
    	...
    	return view('frontend.index',compact('slider','front_products','career_stores','home_tiles','blogs','categories','tiles'));
    }
