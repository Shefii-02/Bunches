...
class TestController extends Controller
{
  ...
  // 
    ...
    //             //     "from" => array(
    //             //         "name" => "MYSWEETIE PIE",
    //             //         "address" => "orders@mysweetiepie.ca"
    //             //     ),
    //             //     "content" => array(
    ...
    public function BounceWebhook(Request $request){
        ...
        //         'content' => [
        //             'name' => 'Developer Team',
        //             'from' => 'developer@stage.mysweetiepie.ca',
        ...
        if (is_array($jsonData) && !empty($jsonData)) {
            ...
            foreach ($jsonData as $item) {
                ...
                Log::info('Email Deliveried Successfully'.$rcpt_to .' : '.$messageId.' => '.$timestamp);
                        ...
                        //             'from' => [
                        //                 'name' => 'Developer Team',
                        //                 'email' => 'developer@stage.mysweetiepie.ca',
                        //             ],
    ...
    public function sendEmail($invoice_id,$recipient)
    {
        ...
        $response = $client->post($this->apiEndpoint . 'transmissions', [
            'json' => [
                ...
                'content' => [
                    'name' => 'Developer Team',
                    'from' => 'developer@mysweetiepie.ca',
